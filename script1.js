...
function runY2K38Demo() {
    const texts = {
        en: "The Y2K38 problem is a future issue affecting Unix-based 32-bit systems. " +
            "Unix systems count time in seconds from January 1, 1970, using a signed 32-bit integer. " +
        ...
        km: "បញ្ហា Y2K38 គឺជាបញ្ហាអនាគត ដែលមានឥទ្ធិពលលើប្រព័ន្ធ Unix 32-bit។ " +
            "ប្រព័ន្ធ Unix គិតពេលវេលាជាវិនាទីចាប់ពីថ្ងៃទី 1 មករា 1970 ដោយប្រើចំនួនគោល 32-bit ដែលមានសញ្ញា។ " +
        ...
        fr: "Le problème Y2K38 est un problème futur affectant les systèmes Unix 32 bits. " +
            "Les systèmes Unix comptent le temps en secondes depuis le 1er janvier 1970 en utilisant un entier signé 32 bits. " +
        ...
        "zh-CN": "Y2K38问题是未来影响Unix 32位系统的问题。 " +
            "Unix系统以1970年1月1日为起点，用带符号的32位整数记录秒数。 " +
        ...
        ja: "Y2K38問題は、Unixベースの32ビットシステムに影響を及ぼす将来の問題です。 " +
            "Unixシステムは1970年1月1日からの秒数を符号付き32ビット整数でカウントします。 " +
        ...
        de: "Das Y2K38-Problem ist ein zukünftiges Problem, das Unix-basierte 32-Bit-Systeme betrifft. " +
            "Unix-Systeme zählen die Zeit in Sekunden ab dem 1. Januar 1970 mit einer vorzeichenbehafteten 32-Bit-Integer. " +
        ...
        "pt-BR": "O problema Y2K38 é uma questão futura que afeta sistemas Unix de 32 bits. " +
            "Os sistemas Unix contam o tempo em segundos desde 1º de janeiro de 1970 usando um inteiro de 32 bits com sinal. " +
        ...
        hi: "Y2K38 समस्या एक भविष्य की समस्या है जो Unix-आधारित 32-बिट सिस्टम को प्रभावित करेगी। " +
            "Unix सिस्टम 1 जनवरी 1970 से सेकंड की गिनती साइनड 32-बिट इंटीजर में करते हैं। " +
        ...
        ru: "Проблема Y2K38 — это будущая проблема, которая затрагивает 32-битные системы на базе Unix. " +
            "Системы Unix отсчитывают время в секундах с 1 января 1970 года, используя знаковое 32-битное целое число. " +
        ...
        ar: "تعد مشكلة Y2K38 مشكلة مستقبلية تؤثر على أنظمة Unix 32-بت. " +
            "تحسب أنظمة Unix الوقت بالثواني منذ 1 يناير 1970 باستخدام عدد صحيح 32 بت مع إشارة. " +
